...
export default function FeaturedShowcase({ projects, variant }: FeaturedShowcaseProps) {
  ...
  return (
    <div className={`relative overflow-hidden rounded-2xl bg-gradient-to-br ${gradient} h-56 sm:h-64`}>
      <div className="absolute inset-0 bg-black/30 dark:bg-black/40 lg:hidden" />

      <div className="absolute inset-0 hidden lg:flex">
        <div className="flex w-3/5 flex-col justify-end p-8">
        </div>
      ...
      <div className="absolute inset-0 flex flex-col justify-end p-6 sm:p-8 z-10 lg:w-3/5">
        <p className="mb-1 text-sm font-medium text-white/70">
          {project.name[locale]}
        </p>
        <h3 className="mb-5 text-3xl font-bold leading-snug text-white sm:text-4xl">
          {showcase.headline[locale]}
        </h3>
        <a
          href={showcase.cta.href}
