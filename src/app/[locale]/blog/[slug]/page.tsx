...
import MDXTrackedLink from '@/components/ui/MDXTrackedLink';
...
export async function generateMetadata({
  ...
  const url = `https://sidequestlab-homepage.vercel.app/${locale}/blog/${slug}`;
        ...
        <div className="container mx-auto px-4">
          <article className="mx-auto max-w-3xl">
            ...
            <div className="prose dark:prose-invert max-w-none">
              <MDXRemote source={post.content} components={{ a: MDXTrackedLink }} />
            </div>
          </article>
        </div>
      </div>
